...
export const ShareEventForm: FC<{ id: string, closeHandle: VoidFunction }> = ({ id, closeHandle }) => {
    ...
    const handleShare = async () => {
        ...
        try {
            await refreshOnDemand(() => axios.post(`/calendar/share-event/${encodeURIComponent(id)}`, { emails }));
            closeHandle();
        } catch (error) {
